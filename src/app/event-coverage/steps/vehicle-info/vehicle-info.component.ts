...
export class VehicleInfoComponent implements OnInit, OnDestroy, OnChanges {
  ...
  brands: Record<'auto' | 'moto', string[]> = {
    auto: [
       'AUTRE', 'ALFA', 'ALFA ROMEO', 'ALPINE', 'AMG', 'ARIEL', 'ARO', 'ASTON MARTIN', 'AUDI', 'AUSTIN HEALEY',
      ...
      'KIA', 'KTM', 'LADA', 'LAMBORGHINI', 'LANCIA', 'LAND ROVER', 'LEGENDS CARS', 'LEXUS', 'LIGIER', 'LOTUS',
      ...
      'TRIUMPH', 'ULTIMA GTR', 'VENTURI', 'VENTURINI', 'VOLKSWAGEN', 'VOLVO', 'WESTFIELD',
    ],
    moto: [
